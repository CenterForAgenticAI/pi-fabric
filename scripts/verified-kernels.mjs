...
const sources = ["LAWS.bend", "PROOF.bend", "proofs/kernel.bend", "proofs/resources.bend", "proofs/resource-spec.bend", "proofs/resource-proof.bend", "proofs/abi.json", "proofs/types.d.ts", "scripts/verified-kernels.mjs"];
